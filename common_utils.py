...
try:
    ...
    from PyQt5.Qt import (Qt, QObject, QIcon, QPixmap, QLabel, QDialog, QHBoxLayout,
                          QTableWidgetItem, QFont, QLineEdit, QComboBox,
                          QVBoxLayout, QDialogButtonBox, QStyledItemDelegate, QDateTime,
                          QRegExpValidator, QRegExp, QTextEdit,
                          QListWidget, QAbstractItemView, QEvent )
except:
    from PyQt4 import QtGui
    from PyQt4.Qt import (Qt, QObject, QIcon, QPixmap, QLabel, QDialog, QHBoxLayout,
                          QTableWidgetItem, QFont, QLineEdit, QComboBox,
                          QVBoxLayout, QDialogButtonBox, QStyledItemDelegate, QDateTime,
                          QRegExpValidator, QRegExp, QTextEdit,
                          QListWidget, QAbstractItemView, QEvent)
...
try:
    ...
    debug_print("FindDuplicates::common_utils.py - exception when loading translations")
    pass
...
class HistoryLineEditWithDelete(HistoryLineEdit):
    def __init__(self, *args):
        ...
        print("HistoryLineEdit::__init__ - self.view()=",self.view())
